...
patterns = [i for i in issues if "pattern" in i.details.lower()]
print(f"TOTAL PATTERNS IN CURRENT: {len(patterns)}")
from collections import Counter
counts = Counter([i.item_name.strip() for i in patterns])
